                ...
                <div class="form-group row m-0">
                    ...
                    <div class="col-md-6 w-100 p-0">
                        ...
                        <div class="tab-content mt-0 border rounded-bottom p-3 border-top-0" id="teethTabContent">
                            ...
                            <div class="row m-0 tab-pane" id="list" role="tabpanel" aria-labelledby="list-tab">
                                <label for="teeth" class="col-md-4 pt-0 col-form-label text-md-right">Select Teeth</label>
                                <select
