                                    ...
                                    <div class="tab-pane show active" id="visual" role="tabpanel"
                                        ...
                                        <div class="tooth-chart mx-auto w-50">
                                            @include('components.teeth-visual', [
                                                'selectedTeeth' => old('teeth', $entry->teeth_list),
                                            ])
                                        </div>
                                    </div>
                ...
                <div class="row mt-5">
                    <div class="col-12">
                        <div class="d-grid gap-2 d-md-flex justify-content-md-end">
                            <a href="{{ route('Entry.index') }}" class="btn btn-outline-secondary">Cancel</a>
                            <button type="submit" class="btn btn-warning px-5 d-flex align-items-center gap-2">
                                <svg width="16" height="16" aria-hidden="true">
