...
<svg xmlns="http://www.w3.org/2000/svg" class="d-none">
    ...
    <symbol id="trash2-fill" viewBox="0 0 16 16">
        <path
...
<header class="navbar navbar-expand-lg navbar-dark bg-dark {{ Route::is('Home') ? '' : 'border-bottom' }}">
    <div class="container-fluid">
        <!-- Brand/Logo -->
        <a class="navbar-brand d-flex align-items-center gap-2" href="{{ route('Home') }}"
            aria-label="Dental Clinic Accounting - Home">
            <svg width="30" height="24" role="img" aria-hidden="true">
        ...
        <div class="collapse navbar-collapse" id="navbarNav">
            <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                <li class="nav-item">
                    <a class="nav-link d-flex align-items-center gap-2{{ Route::is('Home') ? ' active' : '' }}"
                ...
                <li class="nav-item">
                    <a class="nav-link d-flex align-items-center gap-2{{ Route::is('Entry.index') ? ' active' : '' }}"
                        href="{{ route('Entry.index') }}" aria-label="View Entries">
                        <svg width="16" height="16" role="img" aria-hidden="true">
                ...
                <li class="nav-item">
                    <a class="nav-link d-flex align-items-center gap-2{{ Route::is('Item.index') ? ' active' : '' }}"
                        href="{{ route('Item.index') }}" aria-label="View Items">
                        <svg width="16" height="16" role="img" aria-hidden="true">
                ...
                <li class="nav-item">
                    <a class="nav-link d-flex align-items-center gap-2{{ Route::is('Customer.index') ? ' active' : '' }}"
                        href="{{ route('Customer.index') }}" aria-label="View Customers">
                        <svg width="16" height="16" role="img" aria-hidden="true">
                ...
                @if (!Route::is('Home'))
                    <li class="nav-item">
                        <a class="nav-link d-flex align-items-center gap-2{{ Route::is('Entry.trash', 'Item.trash', 'Customer.trash') ? ' active' : '' }}"
                            href="{{ route(explode('.', Route::currentRouteName())[0] . '.trash') }}"
                            aria-label="View Trash">
                            <svg width="16" height="16" role="img" aria-hidden="true">
                                <use href="#trash2-fill" fill="currentColor" />
                            </svg>
                            Trash
                            @if ($trashedCount > 0)
            ...
            <div class="dropdown">
                <button class="btn btn-outline-light dropdown-toggle d-flex align-items-center gap-2" type="button"
                    id="bd-theme" data-bs-toggle="dropdown" aria-expanded="false" aria-label="Toggle theme">
                    <svg width="16" height="16" role="img" aria-hidden="true">
                ...
                <ul class="dropdown-menu dropdown-menu-start dropdown-menu-lg-end p-1" aria-labelledby="bd-theme">
                    <li>
                        <button type="button" class="dropdown-item rounded d-flex align-items-center gap-1"
                    ...
                    <li>
                        <button type="button" class="dropdown-item rounded d-flex align-items-center  gap-1 active"
