...
<tr>
    ...
    <td>{{ $entry->name }}</td>
    <td>
        <a href="{{ url('/search_customer/' . $entry->id) }}" type="button" class="btn btn-sm btn-info col-8 offset-2">View</a>
    </td>
    <td>
        <div class="d-flex justify-content-end gap-2">
            <a href="{{ url('/customers/' . $entry->id) }}/edit" class="text-decoration-none">
    ...
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content rounded-3 shadow">
            <div class="modal-body p-4 text-center">
                <h5 class="mb-0">Delete This Customer?</h5>
...
<script>
    ...
    anchors.forEach(anchor => {
        anchor.addEventListener('click', (e) => {
            ...
            document.querySelector('#deleteModal a').href = `{{ url('/customers') }}/${id}/delete`;
        });
    });
