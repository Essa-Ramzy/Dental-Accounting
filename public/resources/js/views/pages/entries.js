                                ...
                                <td>
                                    <div class="d-flex justify-content-end gap-2">
                                        <a href=" . route('Customer.edit', ['id' => ${
                                            ...
                                            <svg id="edit" width="20" height="20" viewBox="0 0 24 24" fill="none"
                                                ...
                                                <path
                                                    ...
                                                    stroke="var(--bs-body-color)" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
                                                <path
                                        ...
                                        <a class="text-decoration-none" data-bs-toggle="modal" href="#deleteModal" id="${
                                            ...
                                            <svg xmlns="http://www.w3.org/2000/svg" fill="var(--bs-body-color)" width="24" height="24"
                                                viewBox="0 0 24 24">
                                                <path
